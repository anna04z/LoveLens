...
const docFiles: Record<Lang, string> = {
  zh: 'LoveLens_07_混合代码说明.md',
  en: 'LoveLens_07_Mixed_Codes_EN.md',
  ko: 'LoveLens_07_혼합코드설명.md',
}

const ui = {
  zh: { title: '混合代码', subtitle: '当你不只是一种样子', loading: '读取中...' },
  en: { title: 'Mixed Codes', subtitle: 'When you\'re more than one type', loading: 'Loading...' },
  ko: { title: '혼합 코드', subtitle: '당신이 하나 이상의 모습일 때', loading: '불러오는 중...' },
}
